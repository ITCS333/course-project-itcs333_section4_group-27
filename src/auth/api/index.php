...
// Handle preflight for Fetch with CORS
...
// If JSON is invalid, $data will be null
if (!is_array($data)) {
...
require_once __DIR__ . '/db.php'; // adjust path/filename as needed
...
try {
    ...
    error_log('PDOException in auth_login.php: ' . $e->getMessage());
